        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6 lg:p-8">
                <div class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div class="mb-4">
                        <a href="{{ route('usuarios.create') }}" class="bg-cyan-500 dark:bg-cyan-700 hover:bg-cyan-600 dark:hover:bg-cyan-800 text-white font-bold py-2 px-4 rounded">Nuevo Usuario</a>
                    </div>
                    <table class="table-auto w-full">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="border px-4 py-2 text-gray-900 dark:text-white text-center">{{ $usuario->apellidos }}</td>
                                    ...
                                    <td class="border px-4 py-2 text-center">
                                        <div class="flex justify-center">
                                            <a href="{{ route('usuarios.edit', $usuario->id) }}" class="bg-violet-500 dark:bg-violet-700 hover:bg-violet-600 dark:hover:bg-violet-800 text-white font-bold py-2 px-4 rounded mr-2">Editar</a>
                                            <button type="button" class="bg-pink-400 dark:bg-pink-600 hover:bg-pink-500 dark:hover:bg-pink-700 text-white font-bold py-2 px-4 rounded" onclick="confirmDelete('{{ $usuario->id }}')">Eliminar</button>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
...
<script>
    function confirmDelete(id){
        alertify.confirm("Esta Seguro de Eliminar el Usuario Seleccionado", 
        function(e){
            if(e){
