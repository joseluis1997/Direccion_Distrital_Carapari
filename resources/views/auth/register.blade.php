    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
                    ...
                    <div>
                        ...
                        <x-input id="apellidos" class="block mt-1 w-full" type="apellidos" name="apellidos" :value="old('apellidos')" required autocomplete="apellidos" />
                    </div>
                    <div class="mt-4">
                        <x-label for="direccion" value="{{ __('Direccion') }}" />
                        <x-input id="direccion" class="block mt-1 w-full" type="direccion" name="direccion" :value="old('direccion')" required autocomplete="Direccion" />
                    </div>
                    <div class="mt-4">
