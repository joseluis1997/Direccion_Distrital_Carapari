            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6 lg:p-8">
                ...
                <form  action="{{ route('actividades.store') }}" method="post">
                    ...
                    <div>
                        ...
                        <x-input id="nombreAct" class="block mt-1 w-full" type="text" name="nombreAct" :value="old('nombreAct')" required autofocus autocomplete="nombreAct" />
                    </div>
                    <div class="mt-4">
                        <x-label for="fechaI" value="{{ __('Fecha Inicio') }}" />
                        <x-input id="fechaI" class="block mt-1 w-full" type="date" name="fechaI" :value="old('fechaI')" required autocomplete="fechaI" />
                    </div>
                    <div class="mt-4">
                        <x-label for="fechaF" value="{{ __('Fecha Fin') }}" />
                        <x-input id="fechaF" class="block mt-1 w-full" type="date" name="fechaF" :value="old('fechaF')" required autocomplete="fechaF" />
                    </div>
                    <div class="mt-4">
